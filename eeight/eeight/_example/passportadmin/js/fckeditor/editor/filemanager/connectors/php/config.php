...
define( 'ROOT_PATH_FCK', preg_replace('/js(.*)/i', '', str_replace('\\', '/', __FILE__)));
require_once( realpath(ROOT_PATH_FCK.'/index.php') );
if (isset($_SERVER['PHP_SELF']))
{
    define('PHP_SELF_FCK', $_SERVER['PHP_SELF']);
}
else
{
    define('PHP_SELF_FCK', $_SERVER['SCRIPT_NAME']);
}
$sRootPath = preg_replace('/js(.*)/i', '', PHP_SELF_FCK);
...
$Config['UserFilesAbsolutePath'] = realpath(PDIR.'/../passport/upload/editor').'/';
