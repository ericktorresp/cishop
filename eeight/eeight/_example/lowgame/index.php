...
define('PAPPNAME', 'lowgame'); // 定义应用程序名称(不可重复). 核心类 filecaches.php 的基础目录名
...
//模型层(来源lowgame)
$GLOBALS['G_CLASS_FILES']['model_usersession']      = PRJ_MODEL_LOWUSER_PATH . 'usersession.php' ;
...
$GLOBALS['G_CLASS_FILES']['model_gamespecial']      = PRJ_MODEL_LOWUSER_PATH . 'gamespecial.php' ;
$GLOBALS['G_CLASS_FILES']['model_gamemanage']       = PRJ_MODEL_LOWUSER_PATH . 'gamemanage.php' ;
$GLOBALS['G_CLASS_FILES']['model_interface']        = PRJ_MODEL_LOWUSER_PATH . 'interface.php' ;
...
$GLOBALS['G_CLASS_FILES']['model_congealtoreal']    = PRJ_MODEL_LOWUSER_PATH . 'congealtoreal.php' ;
$GLOBALS['G_CLASS_FILES']['model_sendpoints']       = PRJ_MODEL_LOWUSER_PATH . 'sendpoints.php' ;
$GLOBALS['G_CLASS_FILES']['model_checkbonus']       = PRJ_MODEL_LOWUSER_PATH . 'checkbonus.php' ;
$GLOBALS['G_CLASS_FILES']['model_sendbonus']        = PRJ_MODEL_LOWUSER_PATH . 'sendbonus.php' ;
$GLOBALS['G_CLASS_FILES']['model_cancelbonus']      = PRJ_MODEL_LOWUSER_PATH . 'cancelbonus.php' ;
...
$GLOBALS['G_CLASS_FILES']['model_issueerror']       = PRJ_MODEL_LOWADMIN_PATH . 'issueerror.php' ;
$GLOBALS['G_CLASS_FILES']['model_adjustprice']      = PRJ_MODEL_LOWADMIN_PATH . 'adjustprice.php' ;
$GLOBALS['G_CLASS_FILES']['model_sale']             = PRJ_MODEL_LOWADMIN_PATH . 'sale.php' ;
...
if( !defined( 'DONT_USE_APPLE_FRAME_MVC' ) )
{
	...
	//初始化一些全局配置
	$oView->assign("webtitle",getConfigValue("webtitle","低频游戏平台"));
	$oConfig = A::singleton("model_config");
