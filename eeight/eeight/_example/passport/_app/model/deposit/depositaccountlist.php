 ...
 * 列出所有分账户列表
 * 
 * @name	depositAccountList.php
 * @package deposit
 * @version 0.1 11/16/2010
 * @author	Jim
 * 
 */
class model_deposit_depositaccountlist extends model_deposit_depositlist  
{
	/**
	 * 支付银行ID  
	 * @var int
	...
	public function singleList($iPPid=false, $bIsEnable=true, $sParam=NULL, $sPos=NULL){
		...
		$sFields  = is_numeric($iPPid) ? 'aid,acc_name,acc_key,acc_mail,srcbalance,inbalance,outbalance,balance,balance_limit,ads_payport_id,reg_time,valid_time,open_time,isenable' : '*';
