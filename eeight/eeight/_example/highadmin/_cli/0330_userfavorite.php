...
class cli_userfavorite extends basecli
{
    ...
    protected function _runCli()
    {
        ...
        $oUserFavorite = new model_userfavorite();
        $fSartTime = microtime(true);
        $oUserFavorite->insertUserFavorite(); 
...
$oCli = new cli_userfavorite(TRUE); // 生产版本可以考虑改为 FALSE, 关闭调试
EXIT;
?>