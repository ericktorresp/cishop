...
/**
 * 高频后台管理平台, 单入口文件
 * 效验: Tom 2010-01-25 14:57
 * TODO: 仍需对 $GLOBALS['G_CLASS_FILES'] 数组进行校对, 检查缺失和冗余引用, 优化自动载入 
 */
@header("content-type:text/html; charset=UTF-8");
define('IN_APPLE', TRUE);
define('PAPPNAME', 'highadmin'); // 定义应用程序名称(不可重复). 核心类 filecaches.php 的基础目录名
define('PDIR', dirname(__FILE__)); // 项目路径
...
define('PRJ_VERSION',  '1.0.0,         564,         2010-01-13 10:00');
...
$GLOBALS['G_CLASS_FILES']['controller_usergroup']      = PRJ_CONTROLLER_PATH . "usergroup.php";
...
$GLOBALS['G_CLASS_FILES']['controller_method']         = PRJ_CONTROLLER_PATH . "method.php";
...
$GLOBALS['G_CLASS_FILES']['model_usergroup']        = PRJ_MODEL_HIGHADMIN_PATH.'usergroup.php';
$GLOBALS['G_CLASS_FILES']['model_usertree']         = PRJ_MODEL_HIGHADMIN_PATH.'usertree.php';
...
$GLOBALS['G_CLASS_FILES']['model_prizegroup']       = PRJ_MODEL_HIGHADMIN_PATH.'prizegroup.php';
$GLOBALS['G_CLASS_FILES']['model_prizelevel']       = PRJ_MODEL_HIGHADMIN_PATH.'prizelevel.php';
$GLOBALS['G_CLASS_FILES']['model_locks']            = PRJ_MODEL_HIGHADMIN_PATH.'locks.php';
$GLOBALS['G_CLASS_FILES']['model_createlock']       = PRJ_MODEL_HIGHADMIN_PATH.'createlock.php';
...
$GLOBALS['G_CLASS_FILES']['model_charts']           = PRJ_MODEL_HIGHADMIN_PATH.'charts.php';
$GLOBALS['G_CLASS_FILES']['model_marketmgr']        = PRJ_MODEL_HIGHADMIN_PATH.'marketmgr.php';
$GLOBALS['G_CLASS_FILES']['model_adminuser']        = PRJ_MODEL_HIGHADMIN_PATH."adminuser.php";
$GLOBALS['G_CLASS_FILES']['model_databackclear']    = PRJ_MODEL_HIGHADMIN_PATH."databackclear.php";
$GLOBALS['G_CLASS_FILES']['model_admingroup']       = PRJ_MODEL_HIGHADMIN_PATH."admingroup.php";
...
$GLOBALS['G_CLASS_FILES']['model_adminmenu']        = PRJ_MODEL_HIGHADMIN_PATH."adminmenu.php";
//模型层(HIGHGAME平台)
...
function sysMessage( $sMsgDetail, $sMsgType = 0, $aLinks = array() )
{
    ...
    $GLOBALS['oView']->assign('auto_redirection', 
                            '如果您不做出选择，将在 <span id="spanSeconds">'.$iSeconds.'</span> 秒后跳转到第一个链接地址。');
