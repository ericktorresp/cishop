...
class cli_sendbonus extends basecli
{
    ...
    public function __destruct()
    {
        ...
        {
            @unlink( $this->_getBaseFileName() . '_sendbonus_'. $this->iLotteryId. '.locks' );
        }
    }
    ...
    protected function _runCli()
    {
        ...
        $sLocksFileName = $this->_getBaseFileName() . '_sendbonus_'. $this->iLotteryId. '.locks';
        ...
        {
            $oSendBonus->setRunTimes(intval($this->aArgv[2]));
        }
