...
;(function($){
    ...
    $.confirm = function( msg, onYes, onNo, title, width ){//simulate the window`s confirm
        ...
        var html = blockUI_frame_insert({
                        ...
                        title:title,
                        msg:msg,
                        bt_text:'<input type="button" value="'+$.blockUI_lang.button_sure+'" id="confirm_yes" width="50%" height="43" align="center" />&nbsp;&nbsp;<input type="button" value="'+$.blockUI_lang.button_cancel+'" id="confirm_no" />'
                   });
        $html = $(html);
        $.blockUI({
    		message: $html, fadeInTime: 0, fadeOutTime: 0,
    ...
    $.ajaxUploadUI = function(opts){ //ajax upload or load file
        ...
        message = '<form action="'+opts.url+'" id="block_ajaxUploadForm" method="POST" enctype="multipart/form-data" target="block_ajaxUploadIframe"><div id="block_ajaxUploadArea">'+message+'<input type="file" name="'+opts.inputfile+'" id="block_ajaxUploadFile" size="20"></div></form><div id="block_ajaxUploading">'+opts.loadhtml+'</div><div id="block_ajaxUploadError"></div><iframe name="block_ajaxUploadIframe" id="block_ajaxUploadIframe" style="width:0px; height:0px;display:none;"></iframe>';
        var html = blockUI_frame_insert({
                        cl_box:'block_ajaxUpload',
                        isbottom:true,
                        title:opts.title,
                        msg:message,
                        bt_text:'<input type="button" value="'+$.blockUI_lang.button_upload+'" id="block_ajaxConfirm" /><input type="button" value="'+$.blockUI_lang.button_cancel+'" id="block_close" />'
                   });
        $html = $(html);
        $.blockUI({
    ...
    function blockUI_frame_insert( opts ){
        ...
        /*var html = '<table class="block_alert" cellspacing="0" cellpadding="0"  ><tr><td><table width="300px" border="0" cellspacing="0" cellpadding="0"><tr><td width="13" height="13"><img src="./images/new_higame/notic_01.png" width="13" height="13"></td><td background="./images/new_higame/notic_05.png"><img src="./images/new_higame/space.png" width="1" height="1"></td><td width="13" height="13"><img src="./images/new_higame/notic_02.png" width="13" height="13"></td></tr></table><table width="300" border="0" cellspacing="0" cellpadding="0"><tr><td width="13" valign="top" background="./images/new_higame/notic_07.png"><img src="./images/new_higame/space.png" width="1" height="1"></td><td height="100" bgcolor="#253457">';
        if( opts.isbottom ){//if need bottom then add it
            html += '<table width="100%" border="0" cellspacing="5" cellpadding="0"><tr><td ><div id="block_content" style="overflow-x: hidden; overflow-y: visiable;"  >'+opts.msg+'</div></td></tr><tr><td width="50%" height="43" align="center" style="background-position: center center;font-size:16px;" id="block_bottom" colspan="2"><strong>'+opts.bt_text+'</strong></td></tr></table></td><td width="13" valign="top" background="./images/new_higame/notic_08.png"><img src="./images/new_higame/space.png" width="1" height="1"></td></tr></table>';
        }else{
            html += '</table>'
        }
            html += '<table width="300" border="0" cellspacing="0" cellpadding="0"><tr><td width="13"><img src="./images/new_higame/notic_03.png" width="13" height="13"></td><td background="./images/new_higame/notic_06.png"><img src="./images/new_higame/space.png" width="1" height="1"></td><td width="13"><img src="./images/new_higame/notic_04.png" width="13" height="13"></td></tr></table></td></tr></table>';
        */
        var html = '<table  width="300"  border="0" cellpadding="0" cellspacing="1" bgcolor="#131E31"><tr><td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td height="44px" class="table_top_center">温馨提示</td><td  class="table_top_center" width="230px"></td></tr></table><table  width="100%" border="0" cellspacing="0" cellpadding="10" ><tr><td bgcolor="#FFFFFF" id="block_content" height="35px" >'+opts.msg+'</td></tr></table><table width="100%" border="0" cellspacing="0" cellpadding="5"><tr><td align="center" bgcolor="#131E31" id="block_bottom" height="32px">'+opts.bt_text+'</td></tr></table></td></tr></table>'
        return html;
}
