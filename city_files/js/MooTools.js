...
CRIMS.Client = new Class({
	...
	load: function(config){	
		...
		var tmp	= JSON.decode(Cookie.read('CRIMS_Cookie'), {'domain': document.domain});
		...
		Cookie.write('CRIMS_Cookie', JSON.encode(tmp), {'domain': document.domain});
		...
		iframe.addEvent('load',  function() { 
			...
			{
				iframe.contentWindow.CRIMS.init(config);
			}
		});
	}
