...
<head>
    ...
    <!--[if lte IE 6]>
    <style type="text/css">@import "css/style-ie.css";</style>
    <![endif]-->

    <link href="css/winter/style.css" rel="stylesheet" type="text/css" media="screen,print">
    <!--[if lte IE 6]>
    <style type="text/css">@import "css/winter/style-ie.css";</style>
    <![endif]-->
...
<div id="container">
	...
	<script type="text/javascript">
		<!--
		var so = new SWFObject("flash/jackpot_winter.swf", "jackpotContainerFlash", "356px", "126px", "9", "#000000");
	...
	<script type="text/javascript">
		<!--
		var so = new SWFObject("flash/register_winter.swf", "promo2Flash", "432px", "246px", "9", "#000000");
				so.addParam("menu", "false");
				so.addParam("wmode", "transparent");
				so.addParam("allowScriptAccess", "always");
    ...
    <script type='text/javascript'>
        showGameSelector("gameSelectorIcon", 19);
    </script>
    ...
    <div id="bottomContainer">
        <div class="leftColumn">
            <h2 class="header1">Payment Methods</h2>
        ...
        <div class="rightColumn">
            <h2 class="header1">Supported Platforms</h2>
            <div class="bottomContainerBlockContent logos">
                <p>
    ...
    <div id="footer">
        Copyright (c) 2011 Entertainment Ltd., All Rights Reserved. Content may not be duplicated.
        <br><br>
        <a href="/security.html">About Us</a> |
        <a href="/contact.html">Contact Us</a> |
        <a href="/privacy.html">Privacy Policy</a> |
        <a href="/terms-and-conditions.html">Terms &amp; Conditions</a> |

        <a href="/casino-articles/casino-articles.html">Casino Articles</a> |
        <a href="/glossary/glossary.html">Glossary</a> |
        <a href="/press/press.html">Press Releases</a> |

        <a href="/affiliates">Affiliate Program</a> <br /><br />Page rendered in {elapsed_time} seconds
    </div>
</div>
</body>
</html>
