...
INSERT INTO `auth_permission` VALUES ('190', 'Can add robbery', '64', 'add_gangrobbery');
INSERT INTO `auth_permission` VALUES ('191', 'Can change robbery', '64', 'change_gangrobbery');
INSERT INTO `auth_permission` VALUES ('192', 'Can delete robbery', '64', 'delete_gangrobbery');
INSERT INTO `auth_permission` VALUES ('193', 'Can add assault', '65', 'add_gangassault');
INSERT INTO `auth_permission` VALUES ('194', 'Can change assault', '65', 'change_gangassault');
INSERT INTO `auth_permission` VALUES ('195', 'Can delete assault', '65', 'delete_gangassault');
...
-- ----------------------------
INSERT INTO `auth_user` VALUES ('1', 'root', '', '', 'c-mtv@163.com', 'sha1$df48b$97ce6e8393b8ff135c3e794d6e847d6962ea6da8', '1', '1', '1', '2010-05-04 18:26:58', '2010-04-18 20:07:26');
...
INSERT INTO `django_content_type` VALUES ('64', 'robbery', 'game', 'gangrobbery');
INSERT INTO `django_content_type` VALUES ('65', 'assault', 'game', 'gangassault');
...
CREATE TABLE `game_chat` (
  ...
  CONSTRAINT `gang_id_refs_id_140a93d2` FOREIGN KEY (`gang_id`) REFERENCES `game_gang` (`id`),
...
-- ----------------------------
INSERT INTO `game_chat` VALUES ('1', '1', '2', null, null, 'first chat for test.', '2010-05-05 10:59:51');
...
CREATE TABLE `game_gangassault_declined` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `gangassault_id` (`gangassault_id`,`gangmember_id`),
  KEY `gangmember_id_refs_id_69cbd387` (`gangmember_id`),
  CONSTRAINT `gangmember_id_refs_id_69cbd387` FOREIGN KEY (`gangmember_id`) REFERENCES `game_gangmember` (`id`),
  CONSTRAINT `gangassault_id_refs_id_2122867b` FOREIGN KEY (`gangassault_id`) REFERENCES `game_gangassault` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `game_gangrobbery` VALUES ('1', '2', '25', '1', 'planning', '2010-05-05 11:56:25');
...
CREATE TABLE `game_gangrobbery_accepted` (
  ...
  KEY `gangmember_id_refs_id_2cbd10de` (`gangmember_id`),
  CONSTRAINT `gangmember_id_refs_id_2cbd10de` FOREIGN KEY (`gangmember_id`) REFERENCES `game_gangmember` (`id`),
  CONSTRAINT `gangrobbery_id_refs_id_5a2cdd26` FOREIGN KEY (`gangrobbery_id`) REFERENCES `game_gangrobbery` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
