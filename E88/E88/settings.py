# Django settings for e8 project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'e88',                      # Or path to database file if using sqlite3.
        'USER': 'root',                      # Not used with sqlite3.
        'PASSWORD': '2908262',                  # Not used with sqlite3.
...
SECRET_KEY = 'mxp_l(m-((t2je_befpj*0n_dby$z5%p3sqh8+9w*nvk^_h+mh'
